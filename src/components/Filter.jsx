...
const Filter = () => {
    ...
    const selectHandler = (e) => {
        ...
        if (checked) {
            ...
            setFiltered([...filtered.filter((e) => e !== value)])
        }
    }
    return (
        <>
            <div className='filterBox'>
                ...
                <div className="checkBox">
                    <h4>Price</h4>
                    <div className="check">
                        <input type="checkbox" name="" onChange={selectHandler} value={'250'} /> <label>0 - Rs250</label>
                    </div>
                    <div className="check">
                        <input type="checkbox" name="" onChange={selectHandler} value={"251"} /> <label>Rs251-450</label>
                    </div>
                    <div className="check">
